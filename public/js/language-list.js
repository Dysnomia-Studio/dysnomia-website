...
window.addEventListener("load", function(){
    ...
    var icons = [];
    icons.push({'iconFilePath':'https://***REMOVED***/website/img/flags/fr.png', 'iconValue':'Francais'});
    icons.push({'iconFilePath':'https://***REMOVED***/website/img/flags/en.png', 'iconValue':'English'});
    //icons.push({'iconFilePath':'https://***REMOVED***/website/img/flags/ru.png', 'iconValue':'русский'});
    //icons.push({'iconFilePath':'https://***REMOVED***/website/img/flags/de.png', 'iconValue':'Deutsch'});
